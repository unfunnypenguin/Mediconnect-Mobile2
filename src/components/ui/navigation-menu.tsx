...
// Define a new component for bottom navigation
...
>(({ className, children, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "fixed bottom-0 left-0 right-0 bg-background border-t border-border py-2 px-4 flex items-center justify-around z-50",
      className
    )}
    {...props}
  >
...
// Define a component for bottom navigation items
